        ...
        $.ajax({
            ...
            success: function (data) {
                $.each(JSON.parse(data), function (index, obj) {
                    ...
                    if (index === 0) {
                        $("#categary-left ul").append($('<li id="search"><span class="iconfont  icon-search"></span></li><li id="allCate" class="active" style="text-align: center"><p><a href="javascript:void(0)">Tutte le categorie</a></p></li><li data-cateId=' + obj.id + '><a href="javascript:void(0)">' + obj.name + '</a></li>'));
                    } else {
