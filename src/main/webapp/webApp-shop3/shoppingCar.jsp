...
<div id="cart-shop" class="cart-shop">
    ...
    <div id="shopping-car" class="shopping-car">
        ...
        <div class="txt">Shopping cart is empty</div>
        <div>
            <div class="btn btnSure m0"><a href="home.jsp">Go to visit</a></div>
        </div>
    </div>
        ...
        if (${sessionScope.user != null}) {
            $.ajax({
                ...
                success: function (data) {
                   location.href="${pageContext.request.contextPath}/webApp-shop3/orderList.jsp";
                }
            })
        }
        else {
...
<div id="createList" class="createList">
    ...
    <div id="btnPay" class="btnPay" onclick="createOrder()">Create Order</div>
</div>
