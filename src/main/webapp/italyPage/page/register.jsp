...
<title>Reg - Lu Food Mall</title>
<link type="text/css" href="${pageContext.request.contextPath}/italyPage/css/register_150706.css" rel="stylesheet">
<link href="${pageContext.request.contextPath}/italyPage/css/unite_header_1129.css" rel="stylesheet" type="text/css">
<script src="${pageContext.request.contextPath}/italyPage/js/zhuce/pagetop_20121010.js"type="text/javascript"></script>
...
<script >
	$(function () {
            ...
            $.ajax({
                ...
                success :  function (result) {
                    if(result=="success"){
                        ...
                        $("#J_tipVcode").text("Convalida di errore")
                    }
                }
            })
        })
        $("#ueamil").blur(function () {
            ...
            if(mail.trim()!=""){
				...
				if(!corr.test(mail)){
					$("#J_tipSureEmail").text("Errore di formattazione E - Mail")
				}else{
		...
		$("#txt_username").blur(function () {
			...
			$.ajax({
                ...
                success :  function (result) {
                    if(username.trim()==""){
                        $("#J_tipUsername").text("IL nome utente non è vuota")
                    }else{
                        if(result=="success") {
                            $("#J_tipUsername").html("<font  color = 'green'>Congratulazioni, il nome utente può usare</font>")
                        }else{
                            $("#J_tipUsername").text("IL nome utente è già in USO")
                        }
                    }
                }
            })
    ...
    $("#txt_password").blur(function () {
        if($("#txt_password").val().trim()==""){
			$("#J_tipPassword").text("Password non Vuoto")
        }else{
            $("#J_tipPassword").empty()
		}
    })
   ...
   $("#txt_repassword").blur(function () {
         if($("#txt_repassword").val()!=$("#txt_password").val()){
            $("#J_tipSurePassword").text("Due Volte la Password")
         }else{
        ...
        $("#telphone").blur(function () {
			...
			if($("#telphone").val().trim()==""){
                $("#J_tipSureTel").text("IL Numero di cellulare non può essere vuota.")
            }else{
                if(!myreg.test($("#telphone").val())){
                    $("#J_tipSureTel").text("IL Numero di telefono di illegale")
				}else{
                    $("#J_tipSureTel").html("<font color = 'green'>IL Numero di telefono di legittimo</font>")
				}
        ...
        $("#J_submitRegister").click(function () {
			...
			if(utip!="Congratulazioni, il nome utente può usare"){
				flag =false
			}
            if(ptip!=""){
                flag =false
            ...
            if(teltip!="IL Numero di telefono di legittimo"){
                flag =false
            }
            if(mailtip!=""){
                flag =false
            ...
            $.ajax({
                ...
                type : "post",
                success :  function (result) {
                    location.href = "${pageContext.request.contextPath}/italyPage/page/register ok.jsp"
                }
            })}else{
			    alert("Per favore inserire Codice di verifica")
            }
            }else{
            	alert("IL tuo contributo è in errore, per favore, controlla l'entrata")
            }
            }
        })
...
<div class="ddnewhead_wrap">
    <div class="ddnewhead_content ddnewhead_content2">
        <div class="ddnewhead_operate" id="__ddnav_menu">
              ...
              <div class="ddnewhead_logo"><img src="${pageContext.request.contextPath}/chinaPage/img/sp3_3.png" style="width:100%" alt="Lu Food Mall"></a></div>
      <div class="clear"></div>
    </div>
...
<form id="register_form" method="post" action="register.php" onsubmit="return false;">
            ...
            <div id="bd">
				...
				<div class="shadow_box">
					<div class="register_box">
						<div class="head">
							<span class="dd_more"><a href="${pageContext.request.contextPath}/italyPage/page/booklist.jsp?adminId=${sessionScope.adminMsg.id}" class="home">Home Page</a><a href="${pageContext.request.contextPath}/italyPage/page/booklist.jsp?adminId=${sessionScope.adminMsg.id}">Help</a></span>
							<a href="javascript:void(0);" class="head_a head_a1">La registrazione</a>
							
						</div>
						<div class="body">
							<div id="J_cheatProofTop" class="new_tip" style="display:none;">贴心提示：请勿设置与邮箱密码相同的账户登录密码或支付密码，防止不法分子窃取您的账户信息，<a href="${pageContext.request.contextPath}/italyPage/page/booklist.jsp?adminId=${sessionScope.adminMsg.id}">谨防诈骗</a>！</div>
							<table width="100%" cellspacing="0" cellpadding="0" border="0">
								<tbody><tr>
									<td class="t">IL nome utente</td>
									<td class="z_index2">
										<input name="username" id="txt_username" autocomplete="off" maxlength="40" tabindex="1" value="" placeholder="Per favore, inserisci il tuo nome utente" class="text" type="text"><%--<span id="spn_username_ok" class="icon_wrong" style="display: inline-block;">--%></span>
								...
								<tr>
									<td class="t">Conferma Password</td>
									<td>
								...
								<tr>
									<td class="t">IL Numero di telefono</td>
									<td>
								...
								<tr>
									<!-- 图形验证码 -->
									<td class="t j-vcode">Codice</td>
									<td class="j-vcode">
										<input class="text pin" id="txt_vcode" name="txt_vcode" autocomplete="off" placeholder="Per favore, inserisci il Codice" maxlength="5" tabindex="5" type="text">
										...
										<a id="vcodeImgBtn" name="change_code_link" class="code_picww"  onclick="changeImage()">Lo scambio di Foto</a>
									...
									<td class="j-phoneVcode" style="display: none">
										...
										<a class="get_pin get_pinUnClick" id="J_countDownTip" href="${pageContext.request.contextPath}/italyPage/page/booklist.jsp?adminId=${sessionScope.adminMsg.id}" style="display: none;" tabindex="5">2分钟后重新获取</a>
										<a class="get_pin" id="sendMobileCode" href="${pageContext.request.contextPath}/italyPage/page/booklist.jsp?adminId=${sessionScope.adminMsg.id}" tabindex="5">获取短信验证码</a>
								...
								<tr>
									...
									<td class="clause">
										<span class="float_l">
											<input id="chb_agreement" name="chb_agreement" onmouseover="this.style.cursor='pointer';this.style.cursor='hand';" tabindex="7" checked="checked" type="checkbox">Ho letto e accettato
										</span>
								...
								<tr>
									<td class="t">&nbsp;</td>
									<td><a id="J_submitRegister"   class="btn_login" tabindex="10">La registrazione</a><a id="J_submitRegisterUnclick" style="display: none;" class="btn_login">注册中...</a></td>
								</tr>
							</tbody></table>
						</div>
					</div>
			...
			<input name="returnurl" id="returnurl" value="${pageContext.request.contextPath}/italyPage/page/booklist.jsp?adminId=${sessionScope.adminMsg.id}" type="hidden">
        </form>
        <style type="text/css">
...
<div class="footer_nav_box">
	<div class="footer_nav"><a href="${pageContext.request.contextPath}/chinaPage/page/booklist.jsp?adminId=${sessionScope.adminMsg.id}" target="_blank" rel="nofollow">Lu Food Mall</a><span class="sep">|</span><a href="http://mainriversoft.com/main.jsp" target="_blank">MainRiverSoft.com</a><span class="sep">|</span><a href="http://mainriversoft.com/main.jsp" target="_blank">Cooperazione</a><span class="sep">|</span><a href="http://mainriversoft.com/file/toabout" target="_blank">Merchants</a><span class="sep">|</span><a href="http://mainriversoft.com/file/toabout" target="_blank">Ufficiale</a>
		<script>
            var setTo = null;
    ...
    <div class="footer_copyright"><span>Copyright (C) Lu Food Mall 2000-2018, All Rights Reserved</span></div>
    <!-- 有三个icon的时候加footer_icon2 -->
    <div class="footer_icon footer_icon2" style="padding-left: 55px;">
        <div class="validator"><a href="${pageContext.request.contextPath}/italyPage/page/booklist.jsp?adminId=${sessionScope.adminMsg.id}" target="_blank" class="footer_img"><img src="${pageContext.request.contextPath}/italyPage/img/validate.gif"></a></div>
        <div class="knet"><!-- 可信网站LOGO安装开始 -->
            ...
            <a href="${pageContext.request.contextPath}/italyPage/page/booklist.jsp?adminId=${sessionScope.adminMsg.id}" tabindex="-1" id="urlknet" target="_blank" rel="nofollow"><img alt="可信网站" name="CNNIC_seal" src="${pageContext.request.contextPath}/italyPage/img/knetSealLogo.png" oncontextmenu="return false;" onclick="CNNIC_change('urlknet')" width="128" height="47" border="true"></a><!-- 可信网站LOGO安装结束 -->
        </div>
        <div class="validator"><a href="${pageContext.request.contextPath}/italyPage/page/booklist.jsp?adminId=${sessionScope.adminMsg.id}" target="_blank" class="footer_img"><img src="${pageContext.request.contextPath}/italyPage/img/7d593c48-48f6-4fc9-85e0-7d6e10dfc2a2.hpvgUvc9"></a></div>
        <div class="validator"><a id="_pingansec_bottomimagesmall_brand" href="${pageContext.request.contextPath}/italyPage/page/booklist.jsp?adminId=${sessionScope.adminMsg.id}" target="_blank"><img src="${pageContext.request.contextPath}/italyPage/img/brand_128_47.png"></a></div>
        <div class="clear"></div>
    </div>
</div>
</body>
