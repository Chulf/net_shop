...
<div class="ddnewhead_wrap">
    <div class="ddnewhead_content ddnewhead_content2">
        <div class="ddnewhead_operate" id="__ddnav_menu">
              ...
              <div class="ddnewhead_logo"><a href="${pageContext.request.contextPath}/italyPage/page/booklist.jsp?adminId=${sessionScope.adminMsg.id}" title="返回首页" name="ddnav_logo"><img src="${pageContext.request.contextPath}/chinaPage/img/sp3_3.png" style="width:100%" alt="福田食品"></a></div>
      <div class="clear"></div>
    </div>
            ...
            <div id="bd">
				...
				<div class="shadow_box">
					<div class="register_box">
						<div class="head">
							<!--<span class="dd_more"><a href="${pageContext.request.contextPath}/italyPage/page/booklist.jsp?adminId=${sessionScope.adminMsg.id}" class="home">当当首页</a><a href=" ${pageContext.request.contextPath}/italyPage/page/booklist.jsp?adminId=${sessionScope.adminMsg.id}">注册帮助</a></span>
							<a href="javascript:void(0);" class="head_a head_a1">新用户注册</a>-->

						</div>
						<div class="body zccg">
							<p>Congratulazioni, registrazione di successo!</p>
                            <ul><li class="first">IL Numero di telefono</li><li class="last">${sessionScope.userMsg.phone}</li></ul>
                            <div class="zccg_btn"><a href="${pageContext.request.contextPath}/italyPage/page/booklist.jsp?adminId=${sessionScope.adminMsg.id}">立即购物</a><span><em id="time">6</em>秒后自动返回……</span></div>
						</div>
					</div>
				</div>
			</div>
