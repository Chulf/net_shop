...
<table class="table_top">
    <tr>
        <td style="text-align: center;">I dettagli delle Materie Prime</td>
        <td>IL Numero di</td>
        <td>IL Numero di</td>
        <td>In totale</td>
    </tr>
...
<div class="empty" id="empty" hidden>
    <p style="font-weight:bold;font-size:18px;color:#313131;">Non hai ancora effettuato un ordine, puoi farlo：</p>
        ...
        success: function (data) {
            ...
            $.each(data, function (index, o) {
                ...
                var legend = "<fieldset class='order_list'>"
                        + "<legend>Il numero d'Ordine:" + o.sorderEntity.orderNum + "</legend>"
                        + "<table>";
                ...
                var end = "<tr><td colspan='4'>"
                        + "<input type='button' name='' id='' value='Cancella gli ordini' class='delete fr'/>"
                        + "<div class='order_status fr'>"
                        + "Stato：<span>" + o.sorderEntity.orderStatus + "</span>"
                        + "</div> <div class='order_price_total fr'>"
                        + "prezzo：<span>€" + o.sorderEntity.orderSalary + "</span>"
