...
<div class="index_top">
    <div class="index_logo">
        ...
        <div class="fl search">
            <input id="search_box" type="text" name="search_box" placeholder="Trovato, a Fare una passeggiata..."
                   class="search_box fl"/>
...
<div class="banner_box">
    <div class="long_banner" style="padding-left: 224px;">
        <div class="lord_box">
            <button type="button" onclick="toCart()" class="lord_commodity">IL carrello</button>
            <button type="button" onclick="toOrder()" class="lord_order">IL Mio Ordine</button>
        </div>
