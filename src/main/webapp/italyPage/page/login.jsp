...
<title>Login - Lu Food Mall</title>
<link href="${pageContext.request.contextPath}/italyPage/css/login.css" rel="stylesheet" type="text/css" />
<link href="${pageContext.request.contextPath}/italyPage/css/pop_cheat.css" rel="stylesheet" type="text/css" />
...
<script>
  $(function () {
      $("#validate_val").blur(function () {
          ...
          if(validate.trim()==""){
              $("#validate_error").text("Convalida di errore")
              return false;
          }else{
          $.ajax({
      ...
      $("#submitLoginBtn").click(function () {
          ...
          $.ajax({
              ...
              success :  function (result) {
                  if(result=="success"){
                    location.href = "${pageContext.request.contextPath}/italyPage/page/booklist.jsp"
                  }else{
                     alert("IL tuo contributo è sbagliato")
                  }
              }
          })}
...
<body>
<div class="head"> <a href="${pageContext.request.contextPath}/italyPage/page/booklist.jsp?adminId=${sessionScope.adminMsg.id}"> <img src="${pageContext.request.contextPath}/chinaPage/img/sp3_3.png" style="width:190px;"/> </a>
  <div class="improve"><img src="${pageContext.request.contextPath}/italyPage/img/bz.jpg" width="118" height="61" /> </div>
</div>

<div class="login_bg" style="width:960px; margin:0 auto;"> <img src="${pageContext.request.contextPath}/italyPage/page/booklist.jsp?adminId=${sessionScope.adminMsg.id}" style="display: none;">
<div id="J_cheatProofTop" class="new_tip" >
  <div id="component_2747856"></div>
  <div> 为保障账户安全，请勿设置与邮箱及其他网站相同的账户登录密码或支付密码，<a href="${pageContext.request.contextPath}/italyPage/page/booklist.jsp?adminId=${sessionScope.adminMsg.id}">谨防诈骗</a>！ </div>
</div>
      ...
      <div id="J_loginDiv">
        ...
        <div id="J_loginCoreWrap" class="infro">
          <div class="username" id="username_div"> <span></span>
            ...
            <a class="text_del" id="clearUsername" href="${pageContext.request.contextPath}/italyPage/page/booklist.jsp?adminId=${sessionScope.adminMsg.id}" style="display:none;"></a> <a class="replacetype01 " id="selectusertype" href="${pageContext.request.contextPath}/italyPage/page/booklist.jsp?adminId=${sessionScope.adminMsg.id}" style="display:none;">更换类型</a><span class="placeholder" style="position: absolute; z-index: 20; color: rgb(176, 176, 176); width: 270px; height: 34px; font-size: 13.3333px; padding-left: 0px; font-family: 'Microsoft Yahei'; top: 0px; left: 40px; line-height: 34px; display: none; background: none;">邮箱/昵称/手机号码</span></div>
          ...
          <div class="username" id="validate_div"> <span style="background-position:10px -190px;"></span>
            ...
            <a class="text_del" id="clearValidate" href="${pageContext.request.contextPath}/italyPage/page/booklist.jsp?adminId=${sessionScope.adminMsg.id}" style="display:none;"></a></div>
          ...
          <div id="J_vcodeWrap" style="display:none;">
            <div class="code_wrap" id="inputcode" style="display:block;">
              ...
              <a class="code_pic" id="vcodeImgWrap" href="${pageContext.request.contextPath}/italyPage/page/booklist.jsp?adminId=${sessionScope.adminMsg.id}"> <img id="imgVcode" tabindex="4"> </a> <a id="vcodeImgBtn" href="${pageContext.request.contextPath}/italyPage/page/booklist.jsp?adminId=${sessionScope.adminMsg.id}" tabindex="5">换张图</a> </div>
          ...
          <p class="register"> <a style="" id="J_loginToRegister" class="register_btn" href="${pageContext.request.contextPath}/italyPage/page/register.jsp?adminId=${sessionScope.adminMsg.id}" tabindex="9">La registrazione immediatamente</a></p>
        ...
        <div id="J_yidiLoginWrap" class="login_core infro" style="display: none;">
          <ul class="list">
            ...
            <li> <a class="btn" id="J_ePhoneCodeSubmit" href="${pageContext.request.contextPath}/italyPage/page/booklist.jsp?adminId=${sessionScope.adminMsg.id}" tabindex="6">登&nbsp;录</a></li>
          </ul>
        </div>
        <div id="J_yidiBindMobileWrap" class="login_core infro" style="display: none;">
          <ul class="list list-bind">
            ...
            <li>
              <div class="name-bind">Codice：</div>
            ...
            <li><a class="btn-bind" id="J_smsVCodeSubmit" href="${pageContext.request.contextPath}/italyPage/page/booklist.jsp?adminId=${sessionScope.adminMsg.id}">确&nbsp;定</a>
              <p class="later"><a id="J_laterBind" href="${pageContext.request.contextPath}/italyPage/page/booklist.jsp?adminId=${sessionScope.adminMsg.id}">稍后绑定&gt;</a></p>
            </li>
          </ul>
        </div>
...
<div class="footer_nav_box">
  <div class="footer_nav" style="margin-top: 30px"><a href="${pageContext.request.contextPath}/chinaPage/page/booklist.jsp?adminId=${sessionScope.adminMsg.id}" target="_blank" rel="nofollow">Lu Food Mall</a><span class="sep">|</span><a href="http://mainriversoft.com/main.jsp" target="_blank">MainRiverSoft.com</a><span class="sep">|</span><a href="http://mainriversoft.com/main.jsp" target="_blank">Cooperazione</a><span class="sep">|</span><a href="http://mainriversoft.com/file/toabout" target="_blank">Merchants</a><span class="sep">|</span><a href="http://mainriversoft.com/file/toabout" target="_blank">Ufficiale</a>
    <script>
            var setTo = null;
    ...
    <div class="footer_icon footer_icon2" style="padding-left: 55px;">
        ...
        <div class="validator"><a href="${pageContext.request.contextPath}/italyPage/page/booklist.jsp.jsp?adminId=${sessionScope.adminMsg.id}" target="_blank" class="footer_img"><img src="${pageContext.request.contextPath}/italyPage/img/7d593c48-48f6-4fc9-85e0-7d6e10dfc2a2.hpvgUvc9"></a></div>
...
<script>
  $(function(){
    ...
    if (userLogin!="") {
      // console.log("非空");
      window.location="${pageContext.request.contextPath}/italyPage/page/booklist.jsp?adminId=${sessionScope.adminMsg.id}";
    }
